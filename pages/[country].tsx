      ...
      <Container className={styles.container}>
        <Card className='text-center shadow'>
          <Card.Header className='p-4'>
            <img src={data.flags.png} alt={data.name.common} width={225} height={150} />
          </Card.Header>
          <Card.Body>
            ...
            <Accordion>
              ...
              <Accordion.Item eventKey='1'>
                ...
                <Accordion.Body className='fw-bold fs-5'>{data.region}</Accordion.Body>
              </Accordion.Item>
              <Accordion.Item eventKey='2'>
                <Accordion.Header>Sub-Region:</Accordion.Header>
                <Accordion.Body className='fw-bold fs-5'>{data.subregion}</Accordion.Body>
              </Accordion.Item>
              <Accordion.Item eventKey='3'>
                <Accordion.Header>Population:</Accordion.Header>
                <Accordion.Body className='fw-bold fs-5'>
                  <IoIosPeople size={30} /> {Number(data.population).toLocaleString()}
                </Accordion.Body>
              </Accordion.Item>
              <Accordion.Item eventKey='4'>
                <Accordion.Header>Area:</Accordion.Header>
                <Accordion.Body className='fw-bold fs-5'>
                  <FaRulerCombined size={20} /> {Number(data.area).toLocaleString()} km²
                </Accordion.Body>
              </Accordion.Item>
              ...
              <Accordion.Item eventKey='6'>
                ...
                <Accordion.Body className='fw-bold fs-5'>
                  {data.currencies &&
                    Object.entries(Object.values(data.currencies)[0]).map(([key, value]) => (
                      <li key={key}>
                        {key}: <i>{value}</i>
                      </li>
                    ))}
